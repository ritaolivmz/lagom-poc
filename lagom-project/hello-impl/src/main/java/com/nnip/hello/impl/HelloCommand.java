...
public interface HelloCommand extends Jsonable {
  ...
  @Immutable
  @JsonDeserialize
  public final class UseGreetingMessage implements HelloCommand, CompressedJsonable, PersistentEntity.ReplyType<String> {
...
/*
    @JsonCreator
    public UseGreetingMessage(String message, String id) {
      this.message = Preconditions.checkNotNull(message, "message");
    }*/
  ...
  @Immutable
  @JsonDeserialize
  public final class Test implements HelloCommand, PersistentEntity.ReplyType<String> {
    public final String message;
    public final String name;

    @JsonCreator
    public Test(String message, String name) {
      this.name = Preconditions.checkNotNull(name, "name");
      this.message = Preconditions.checkNotNull(message, "message");
    }
    ...
    @Override
    public String toString() {
      return MoreObjects.toStringHelper("Test").add("message", message).add("name", name).toString();
    }
  }
