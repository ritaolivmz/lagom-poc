...
import com.nnip.hello.impl.MsgEvent.GreetingMessageChanged;
...
public class HelloEntityTest {
  ...
  public void testHelloWorld() {
    PersistentEntityTestDriver<HelloCommand, MsgEvent, MsgState> driver = new PersistentEntityTestDriver<>(system,
        new MsgEntity(), "world-1");

    Outcome<MsgEvent, MsgState> outcome1 = driver.run(new Hello("Alice", Optional.empty()));
    assertEquals("Hello, Alice!", outcome1.getReplies().get(0));
    //assertEquals(Collections.emptyList(), outcome1.issues());

    Outcome<MsgEvent, MsgState> outcome2 = driver.run(new UseGreetingMessage("Hi"),
